...
namespace SmebyFX_blog.Post.Services
{
    public class PostService
    {
        ...
        private readonly PostTagDao _postTagDao;

        public PostService(PostDao postDao = null, TagDao tagDao = null, PostTagDao postTagDao = null)
        {
            _postDao = postDao ?? new PostDao();
            _tagDao = tagDao ?? new TagDao();
            _postTagDao = postTagDao ?? new PostTagDao();
        }
